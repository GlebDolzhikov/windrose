...
Meteor.methods({
    ...
    updateDomEl: function (obj,id,bortId,dayId) {
        ...
        var skedId = Data.findOne(id).skedId;
        if(this.userId){
                 ...
                 Data.update({_id: id},
                        {
                            $set: {
                                ...
                                bortName: Data.findOne({name:"bort",createdAt:bortId,skedId:skedId}).bort,
                                bortId: Data.findOne({name:"bort",createdAt:bortId,skedId:skedId})._id
                            }
                        }
                 );
            }
    ...
    copyFlt: function(positon,dayId,bortId,skedId,elementId){
        if(this.userId){
            ...
            if (user.username!='Guest') {
                ...
                newFlt.bortName = Data.findOne({name:"bort",createdAt:bortId,skedId:skedId}).bort;
                newFlt.bortId = Data.findOne({name:"bort",createdAt:bortId,skedId:skedId})._id;
                ...
                if (this.userId) {
                    ...
                    if (user.username != 'Guest') {
                        ...
                        Data.insert({
                            ...
                            depSlot:false,
                            arrSlot:false,
                            bortName: Data.findOne({name:"bort",createdAt:bortId}).bort,
                            bortId: Data.findOne({name:"bort",createdAt:bortId})._id
                        });
                    }
                }
            }}
